...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/stephannordneseriksen/Documents/github/ruby_ship/tools/../bin/darwin_ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/stephannordneseriksen/Documents/github/ruby_ship/tools/../bin/darwin_ruby' '--with-opt-dir=/usr/local/opt/openssl:/usr/local/opt/readline:/usr/local/opt/libyaml:/usr/local/Cellar/gdbm/1.10:/usr/local/opt/libffi'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/stephannordneseriksen/Documents/github/ruby_ship/tools/../bin/darwin_ruby"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress -L/usr/local/opt/openssl/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/Cellar/gdbm/1.10/lib -L/usr/local/opt/libffi/lib "
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " -I/usr/local/opt/openssl/include -I/usr/local/opt/readline/include -I/usr/local/opt/libyaml/include -I/usr/local/Cellar/gdbm/1.10/include -I/usr/local/opt/libffi/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fstack-protector -L/usr/local/lib -L/usr/local/opt/openssl/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/Cellar/gdbm/1.10/lib -L/usr/local/opt/libffi/lib "
